...
Evidence should include approved policies, architecture and threat reviews, processing records, DPIAs, contracts/subprocessor review, access review, secure-development results, vulnerability remediation, penetration tests, key rotation, incident exercises, retention/deletion tests, backup restoration, monitoring, training, and release approvals.

## Claims governance

Public and internal claims require legal/privacy and security approval. Use “designed to support” rather than “compliant” until scope-specific evidence is independently assessed. Reassess after material architecture, data, vendor, jurisdiction, or purpose changes.
