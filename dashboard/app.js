...
const legalNotices = Object.freeze({
  privacy: {
    title: 'Privacy notice', summary: 'How this development service handles personal data and where deployment-specific information must be supplied.',
    sections: [
      ['Status and responsible operator', '<p>BeyondBeams is a pre-production software project, not an approved live public service. The institution or company that deploys an instance is the responsible service operator and must identify the applicable controller, processor roles, legal entity, address, privacy contact, data protection officer where required, and supervisory authority before allowing real users or real personal data.</p><p>This repository does not name or authorize a production operator.</p>'],
      ['Information handled', '<p>The public pages can be viewed without creating an account. When institutional sign-in is configured, the service may process identity and authorization claims, tenant and workload identifiers, session and security data, case inputs, workflow records, notes, evidence metadata, policy decisions, signed authorization records and receipts, audit events, and operational security telemetry.</p><p>Case content may contain personal or sensitive information depending on the deploying institution. This prototype must not be used with real personal data.</p>'],
      ['Purposes and legal basis', '<p>Information is intended to be used to authenticate authorized users, enforce access and policy controls, manage governed cases, support human review and remedy, preserve security and audit evidence, prevent misuse, and operate the service. A deploying operator must document a lawful basis for every purpose and category of data. Consent must not be treated as a default basis where law, public task, contract, legitimate interests, or another basis is applicable.</p>'],
      ['Sharing, processors and transfers', '<p>The repository does not select production hosting, identity, telemetry, storage, notification, scanning, or support providers. A deploying operator must publish its actual processors, recipients, hosting locations, international transfer safeguards, government-access rules, and procurement controls. Data must not be sold or used for advertising by this project.</p>'],
      ['Retention and security', '<p>Development adapters use local, single-host storage and are not production controls. The deploying operator must define and test record-specific retention, deletion, legal hold, backup, access, encryption, key custody, incident response, and recovery controls. No Internet transmission or storage system can be represented as absolutely secure.</p>'],
      ['Individual rights and decisions', '<p>Applicable rights may include access, correction, deletion, restriction, objection, portability, complaint, and safeguards concerning automated decisions. Availability and exceptions depend on local law and the operator’s role. BeyondBeams outputs are simulated recommendations or records; they must not be treated as legal determinations or as authority for solely automated consequential decisions.</p><p>Requests must be directed to the deploying operator through its published privacy and non-digital channels.</p>'],
      ['Children and changes', '<p>This development service is not directed to children and must not be configured for children’s data without enhanced legal, safeguarding, rights, security, and independent review. Material changes to processing require an updated notice and, where applicable, renewed assessment or notice.</p>']
    ]
  },
  cookies: {
    title: 'Cookie notice', summary: 'A plain account of the browser storage used by this development service.',
    sections: [
      ['Current use', '<p>Public pages do not set analytics, advertising, preference, or social-media cookies. The application does not use persistent or session-scoped Web Storage. It does not load fonts from a third-party service.</p>'],
      ['Strictly necessary session cookie', '<p>After a configured institutional sign-in succeeds, the server sets one opaque session cookie. Its default name is <code>beyondbeams_session</code>. It is used only to authenticate the browser session, apply tenant and authorization controls, and support logout and session rotation.</p><div class="legal-table-wrap"><table class="legal-table"><thead><tr><th>Cookie</th><th>Purpose</th><th>Properties</th><th>Duration</th></tr></thead><tbody><tr><td><code>beyondbeams_session</code></td><td>Institutional authentication and security</td><td><code>HttpOnly</code>, <code>SameSite=Lax</code>, path <code>/</code>; <code>Secure</code> on HTTPS deployments</td><td>Until the configured session expiry; the synthetic test provider defaults to 15 minutes</td></tr></tbody></table></div>'],
      ['Consent and control', '<p>The current cookie is strictly necessary for a user-requested authenticated workspace, so the prototype does not display a consent banner for it. Users can remove it by signing out or clearing site data, but protected features will then stop working. Any operator that adds optional analytics, personalization, embedded media, advertising, or other storage must first update this notice and implement valid consent controls where required.</p>'],
      ['Identity provider cookies', '<p>A separately configured institutional identity provider may use cookies on its own domain. Those cookies are controlled by that provider and must be covered by the deploying operator’s identity and privacy notices.</p>']
    ]
  },
  terms: {
    title: 'Terms & conditions', summary: 'The conditions for accessing this pre-production project and its development interface.',
    sections: [
      ['Scope and acceptance', '<p>These terms apply to this development interface and project materials. By accessing them, you agree to use them only for lawful evaluation, authorized development, or institution-approved testing. A production operator must replace or formally adopt these terms with its legal identity, contact details, governing law, dispute process, service description, and any mandatory local terms before offering a live service.</p>'],
      ['Prototype only', '<p>BeyondBeams is provided for development and synthetic evaluation. It is not production-ready, independently audited, certified, approved by a government, or suitable for real personal data. Agent outputs are simulated and are not legal, regulatory, security, medical, financial, eligibility, enforcement, or other professional advice or decisions.</p>'],
      ['Authorized use', '<p>You must not attempt unauthorized access; bypass authentication, A2SPA authorization, policy, tenant, review, or audit controls; introduce malicious code; disrupt the service; probe another user or tenant; upload unlawful or harmful material; expose credentials or personal data; misrepresent an output as an official decision; or use the project to conceal accountability, suppress rights, discriminate, or conduct unlawful surveillance.</p>'],
      ['Accounts and institutional authority', '<p>Accounts are supplied by a configured institution, not registered publicly. You are responsible for activity under your authorized session and must promptly report suspected compromise through the operator’s approved private channel. Access may be suspended or revoked to protect users, institutions, evidence, or the service.</p>'],
      ['Intellectual property', '<p>Copyright © 2026 BeyondBeams project owners. All rights are reserved. Public source availability does not grant a license to use, copy, modify, deploy, distribute, sublicense, sell, or create derivative works except with prior written permission or as required by law. Third-party components remain subject to their own terms.</p>'],
      ['No warranties', '<p>To the maximum extent permitted by applicable law, the project and interface are provided “as is” and “as available,” without warranties of accuracy, availability, security, fitness for a particular purpose, non-infringement, compliance, or error-free operation. Nothing in these terms excludes a warranty or right that cannot lawfully be excluded.</p>'],
      ['Liability', '<p>To the maximum extent permitted by applicable law, the project owners and contributors are not liable for indirect, incidental, special, consequential, exemplary, or punitive loss, or for loss of data, revenue, opportunity, goodwill, or service arising from use of or inability to use this prototype. Liability that cannot lawfully be excluded or limited remains unaffected. A deploying operator must obtain counsel before setting any monetary cap or institution-specific allocation of risk.</p>'],
      ['Indemnity and enforcement', '<p>Where permitted by applicable law, an organizational user is responsible for claims, loss, and reasonable costs arising from its unlawful use, violation of these terms, or infringement of third-party rights. The project owners may restrict access, preserve evidence, and cooperate with lawful investigations. This clause does not apply where prohibited or to the extent a claim results from the protected party’s own unlawful conduct.</p>'],
      ['Governing terms and changes', '<p>No governing jurisdiction or contracting legal entity is established in this repository. Mandatory law applies despite these terms, and a production operator must publish an enforceable governing-law and dispute clause. Terms may be updated as the project changes; material changes should be identified by a revised effective date.</p>']
    ]
  }
});

function renderLegal(kind) {
  const notice = legalNotices[kind];
  document.title = `${notice.title} — BeyondBeams`;
  main.innerHTML = `<article class="page legal-page"><header class="legal-hero"><p class="eyebrow">Legal / Public notice</p><h1 class="page-title">${notice.title}</h1><p class="lede">${notice.summary}</p><div class="legal-meta"><span>Effective 14 August 2026</span><span>Version 1.0</span><span>Development service</span></div></header><aside class="legal-warning"><strong>Deployment notice</strong><p>This is a project-level baseline, not jurisdiction-specific legal advice. No company legal name, registered address, operating jurisdiction, or public privacy contact is established in the repository. Those details and qualified legal approval are required before public or production use.</p></aside><div class="legal-layout"><nav class="legal-toc" aria-label="On this page"><p class="footer-label">On this page</p>${notice.sections.map((section, index) => `<a href="#legal-${index + 1}"><span>${String(index + 1).padStart(2, '0')}</span>${section[0]}</a>`).join('')}</nav><div class="legal-copy">${notice.sections.map((section, index) => `<section id="legal-${index + 1}"><p class="legal-number">${String(index + 1).padStart(2, '0')}</p><h2>${section[0]}</h2>${section[1]}</section>`).join('')}</div></div></article>`;
}
...
function renderAgents() {
  document.title = 'Intelligence agents — BeyondBeams';
...
function renderAgent(agent) {
  document.title = `${agent.name} — BeyondBeams`;
...
async function renderCaseDetail(caseId) {
  document.title = 'Case detail — BeyondBeams'; main.innerHTML = `<div class="page"><div id="case-detail" aria-live="polite"><div class="empty-state"><p>Loading protected case…</p></div></div></div>`; const container = document.querySelector('#case-detail'); if (!state.authenticated) return unauthorized(container);
...
async function renderAudit() {
  document.title = "Audit administration — BeyondBeams";
  main.innerHTML = `<div class="page">${heading("Administration / 04", "Audit & integrity.", "Protected operational evidence. Access attempts are themselves audited.")}<div id="audit-content" class="content-grid" aria-live="polite"><div class="empty-state"><p>Checking authorization…</p></div></div></div>`;
  const container = document.querySelector("#audit-content");
  if (!state.authenticated) return unauthorized(container, "This area requires audit:verify or audit:export scope assigned by your institution.");
  try {
    const integrity = await request("/audit/integrity");
    container.innerHTML = `<section class="audit-card"><p class="eyebrow">Ledger verification</p><span class="integrity-value ${integrity.valid ? "good" : ""}">${integrity.valid ? "Intact" : "Invalid"}</span><p>Local hash-chain verification completed. This is development evidence, not production assurance or approval.</p><pre>${safe(JSON.stringify(integrity, null, 2))}</pre></section><aside class="panel"><h2>Audit actions</h2><p class="heading-note">Exports are restricted to the authenticated tenant and require a separate scope.</p><button id="export-audit" class="button primary" type="button">Export tenant records</button><p id="audit-error" class="field-error" aria-live="polite"></p></aside>`;
    document.querySelector("#export-audit").addEventListener("click", exportAudit);
  } catch (error) {
    container.innerHTML = error.status === 403 ? "<div class=\"empty-state\"><h2>Insufficient audit scope.</h2><p>Your session is valid, but this administrative evidence is not available to your assigned permissions.</p><a class=\"button\" href=\"/dashboard\">Return to dashboard</a></div>" : errorState(error);
  }
}
async function exportAudit() { const error = document.querySelector('#audit-error'); try { const records = await request('/audit/export'); const blob = new Blob([JSON.stringify(records, null, 2)], { type: 'application/json' }); const link = document.createElement('a'); link.href = URL.createObjectURL(blob); link.download = 'beyondbeams-audit-development.json'; link.click(); URL.revokeObjectURL(link.href); } catch (requestError) { error.textContent = requestError.message; } }
