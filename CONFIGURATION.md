...
| `EXPO_PUBLIC_API_URL` | Mobile | Yes | No | Full `/execute` endpoint embedded in client |
| `EXPO_PUBLIC_API_KEY` | Mobile | Yes | Public | Restricted client credential embedded in build |
